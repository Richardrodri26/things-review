...
export function MovieDetailPage({ movieId, defaultGroupId, backHref }: MovieDetailPageProps) {
  ...
  if (!movie) {
    return (
      <div className="flex flex-1 flex-col gap-4 p-4">
        <Link href={backHref ?? ROUTES.MOVIES} className="inline-flex items-center gap-1.5 text-sm h-9 px-3 rounded-md hover:bg-accent transition-colors w-fit">
